...
gpu_matmult <- rbind(gpu_matmult.gpu1,gpu_matmult.gpu2,gpu_matmult.gpu3_row,gpu_matmult.gpu3_col,gpu_matmult.gpu4,gpu_matmult.gpulib,gpu_matmult.lib)
...
ggplot(data=gpu_matmult, aes(x=Memory, y=Flops,col=Type)) + ylim(0,65)+xlim(0,4.5)+
  geom_line()+geom_point()+labs(x="Memory(MB)", y="GFlops/s")
